            ...
            >
              <template #icon>
                <v-avatar>
                  <v-img
                    :src="
                      require(`@/assets/exp-icons/${experience.companyIcon}`)
                    "
                  />
                </v-avatar>
              </template>
  ...
  data: () => ({
    experiences: [
      ...
      },
      {
        ...
        description:
          "Design, develop and implement complex workflow applications for a wide-range of industries such as Manufacturing, Banking, Human Resources, and Education.",
        skills: [
