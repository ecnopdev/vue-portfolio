        ...
        <v-row>
          ...
          <v-col cols="12" md="8" class="px-xs-0">
            <ul>
              <li>
                Hi, my name
                <b>Jose</b>. Sometimes people call me
                <b>JM</b> or
                <b>Ecnop</b> (which is my last name spelled backwards).
              </li>
              <li>
                I am a
                <b>Software Engineer</b> with over a decade
                professional experience. Aside from coding, I also enjoy
                solving challenging problems and building things at scale.
              </li>
              <li>
              ...
              <li>
                I'm a
                <b>gamer</b> who likes multi-player, role-playing, and co-op
                strategy games.
              </li>
              <li>
                I'm a
                <b>puzzle junkie</b> especially when placed in a competitive
                environment.
              </li>
              <li>
                I'm an
              ...
              <li>
                And to top all that, I'm a
                <b>dad</b> two beautiful children
...
.profile-picture-container {
  ...
  height: 300px;
  text-align: center;
  box-shadow: rgb(210, 210, 210) -10px 10px;
}
</style>
<script>
